...
// Base library type I2C
{
    ...
    fd = wiringPiI2CSetup (0x76) //if return is negative error has occurred
	_address = fd; //set interface used for communication
}
...
{  
	...
	for(i = 0; i <= 7; i++)
  {
        ...
        uint8_t highByte = wiringPiI2CReadReg8(_address,)       //YOU STOPPED HERE NIMROD. FIX IT.
